...
<head>
    ...
    <link rel="icon" href="http://127.0.0.1:8000/images/favicon.svg" type="image/gif">
...
<body>
    ...
    <section class="site-content">
        ...
        <section class="hero-section position-relative">
            <div class="container">
                <div class="hero-section-wrapper" style="padding-bottom: 0.5rem;">
                    <div class="row align-items-center">
                        <div class="col-xl-7">
                            <div class="hero-section-content text-center text-xl-start">
                                <h1 class="heading-title text-nowrap">{{ $curso->nombre }}</h1>
                                <p class="text">
                                    {{ $curso->descripcion }}
                                    Encuentra este y muchos más cursos en nuestra web que te ayudarán a mejorar tus opciones de adquirir un mejor empleo.
                                </p>
                                <div
                                    class="hero-btn d-md-flex align-items-center justify-content-center justify-content-xl-start">
                                    @if(session()->has('user_id'))
                                        <a class="btn btn-primary mb-3 mb-sm-0" href="{{ $siguiente }}">Siguiente Capítulo</a>
                                    @else 
                                        <a class="btn btn-primary mb-3 mb-sm-0" href="/login">Iniciar Sesión</a>
                                    @endif
                                    <a class="btn btn-primary how-it-work bg-transparent" href="#">
                                        <img src="../images/icons/play-circle.svg" alt="">
                                        <span class="border-bottom">Capítulo: {{ $capitulo->num_capitulo }}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5">
                            <div class="hero-img">
                                <iframe width="560" height="315" src="{{ $capitulo->enlace_video }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </div>
