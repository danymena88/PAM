...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form action="/linea_produccion/actualizar/{{ $lineaProduccion->idlinea_produccion }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="nombre" class="form-label">Nombre linea</label>
                            <input type="text" class="form-control" id="nombre" name="nombre" value="{{ $lineaProduccion->nombre }}">
                        </div>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="isactive" name="isactive" {{ $lineaProduccion->isactive == "Y" ? "checked" : "" }}>
