            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Capítulos de Cursos</h4>
                                    <h6 class="card-subtitle">Busca un capítulo para poder eliminarlo de <code style="color:blueviolet; font-size: 1rem;">Codeffee</code>.</h6>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                ...
                                <tbody id="search_list">
                                    ...
                                    <tr>
                                        <td><span class="fs-6">{{ $capitulo->id; }}</span></td>
                                        <td>{{ $capitulo->num_capitulo; }}</td>
                                        <td>{{ $capitulo->descripcion; }}</td>
                                        <td>{{ $capitulo->nombre; }}</td>
                                        <td>{{ $capitulo->created_at; }}</td>
                                        <td><a href="capitulos-acciones/{{ $capitulo->id }}/eliminar" class="btn btn-dark">Eliminar</button></a>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Agregar Capitulo</h4>
                                <h6 class="card-subtitle">Llena los campos solicitados para agregar un capítulo en <code style="color:blueviolet; font-size: 1rem;">Codeffee</code>.</h6>
                                <form class="mt-4" action="capitulos-acciones" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <select class="form-select" id="inputGroupSelect04" name="id_curso" required>
                                            <option selected="" value="off">Selecciona...</option>
                                            @foreach ($cursos as $curso)
                                            <option value="{{ $curso->id }}">{{ $curso->nombre }}</option>
                                            @endforeach
                                                                                    </select>
                                        <small id="name" class="form-text text-muted">¿A qué curso pertenece?</small>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-sm-6 col-md-4">
                                            <input type="number" class="form-control" name="num_capitulo" value="1">
                                            <small id="name" class="form-text text-muted">Número del capítulo</small>
                                        </div>
                                        <div class="col-sm-6 col-md-8">
                                            <input class="form-control" maxlength="49" name="enlace_imagen" required>
                                            <small id="name" class="form-text text-muted">Enlace de imagen</small>
                                        </div>

                                    </div>
                                    <div class="form-group mt-3">
                                        <input class="form-control" maxlength="49" name="descripcion" required>
                                        <small id="name" class="form-text text-muted">Descripción del capitulo</small>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-sm-12">
                                            <input class="form-control" maxlength="199" name="enlace_video" required>
                                            <small id="name" class="form-text text-muted">Enlace del video</small>
                                        </div>
                                    </div>
