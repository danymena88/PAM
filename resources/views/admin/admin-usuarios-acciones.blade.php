            ...
            <div class="container-fluid">
                <div class="row">
                    <ul class="navbar-nav float-end">
                        ...
                        <!-- Search -->
                        <!-- ============================================================== -->
                        <li class="nav-item d-none d-md-block mb-5">
                            <a class="nav-link" href="javascript:void(0)">
                                    <div class="customize-input">
                                        <input class="form-control custom-shadow custom-radius border-0 bg-white"
                                            type="search" placeholder="Buscar Usuario..." aria-label="Search" onfocus="this.value='' " id="search" name="search">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-subtitle">Busca un usuario para que puedas actualizarlo o eliminarlo de <code style="color:blueviolet; font-size: 1rem;">Codeffee</code>.</h6>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Editar o Eliminar Usuario</h4>
                                <form class="mt-4" action="{{$encontrado->id}}/update" method="POST">
                                    @csrf
                                    @if ($encontrado->name != '$$$')
                                    <div class="row">
                                    <div class="form-group col-md-4">
                                        <input type="text" class="form-control" name="nombre" value="{{ $encontrado->name }}" required>
                                        <small id="name" class="form-text text-muted">Nombre de Usuario</small>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <input class="form-control" maxlength="49" name="email" value="{{ $encontrado->email }}" required>
                                        <small id="name" class="form-text text-muted">Email</small>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <input class="form-control" maxlength="49" name="rol" value="<?php
                                        if ($encontrado->id_rol == 1)
                                        {
                                            echo 'Administrador';
                                        }
                                        else {
                                        ...
                                        ?>" required>
                                        <small id="name" class="form-text text-muted">Rol</small>
                                    </div>
                                    </div>
                                    <div class="form-actions mt-2">
                                    <div class="row">
                                        <div class="form-group col-md-2">
                                            <input class="form-control" maxlength="49" name="descripcion" value="{{ $encontrado->id }}" readonly required>
                                            <small id="name" class="form-text text-muted">Id</small>
                                        </div>
                                    </div>
                                        <div class="text-end">
                                            <button type="submit" class="btn btn-info">Actualizar</button>
                                            <a class="btn btn-dark" href="{{ $encontrado->id }}/eliminar">Eliminar</a>
                                        </div>
                                    </div>
                                    @else
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <input type="text" class="form-control" name="nombre" readonly required>
                                            <small id="name" class="form-text text-muted">Nombre de Usuario</small>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <input class="form-control" maxlength="49" name="descripcion" readonly required>
                                            <small id="name" class="form-text text-muted">Email</small>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <input class="form-control" maxlength="49" name="descripcion" readonly required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="text-end">
                                                <button type="submit" class="btn btn-info">Actualizar</button>
                                                <a href="eliminar"><button class="btn btn-dark">Eliminar</button></a>
                                            </div>
                                        </div>
                                        @endif
                                </form>
