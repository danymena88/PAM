                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">Te presentamos los cursos disponibles en <code style="color:blueviolet; font-size: 1rem;">Codeffee</code>.</h6>
                    ...
                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                        ...
                        <tbody id="search_list">
                            @foreach ($cursos as $curso)
                                ...
                                <td><a href="<?php
                                    $delimiter = '-'; 
                                    $slug = strtolower(trim(preg_replace('/[\s-]+/', $delimiter, preg_replace('/[^A-Za-z0-9-]+/', $delimiter, preg_replace('/[&]/', 'and', preg_replace('/[\']/', '', iconv('UTF-8', 'ASCII//TRANSLIT', $curso->nombre))))), $delimiter));echo 'cursos/' . $slug;?>" class="btn btn-primary">Más Información</a>
                            </td></tr>@endforeach
                                                            </tbody>
                    </table>
                </div></div></div></div>                    
