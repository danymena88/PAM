            ...
            <nav class="navbar navbar-expand-lg py-0">
                <div class="container-fluid">
                    <div class="logo d-flex align-items-center justify-content-between">
                        <a class="navbar-brand py-0 me-0" href="#"><img src="../images/logo.png" alt=""></a>
                        <!-- mobile toggle -->
            ...
            <div class="container">
                <div class="hero-section-wrapper" style="padding-bottom: 0.5rem;">
                    <div class="row align-items-center">
                            ...
                            <div class="hero-section-content text-center text-xl-start">
                                ...
                                <div
                                    ...
                                    @if(session()->has('user_id'))
                                        <a class="btn btn-primary mb-3 mb-sm-0" href="suscripcion/{{ $curso->id }}">Suscríbete al curso</a>
                                    @else 
                                    ...
                                    <a class="btn btn-primary how-it-work bg-transparent" href="#">
                                        ...
                                        <a href="{{ $slug }}/1" class="border-bottom">Número de capítulos: {{ $curso->capitulos }}</a>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5">
                            <div class="hero-img">
                                <img src="{{ $curso->enlace_imagen }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="how-it-works-wrapper">
                    <div class="section-title text-center">
                        <h2 class="title text-uppercase">Precio: <span class="primary-text">${{ $curso->precio }}.00</span></h2>
                    </div>
                </div>
            </div>
        </section>
